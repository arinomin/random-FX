...
export function ControlPanel({
  ...
  const buttonVariants = {
    idle: {
      ...
      y: 0,
      boxShadow:
        "0 0 10px rgba(0, 255, 0, 0.3), inset 0 0 10px rgba(0, 255, 0, 0.1)",
    },
    pressed: {
      scale: 0.95,
      y: 6,
      boxShadow:
        "0 0 5px rgba(0, 255, 0, 0.2), inset 0 0 15px rgba(0, 255, 0, 0.3)",
    },
    generating: {
      scale: [1, 1.03, 1],
      y: [0, -2, 0],
    ...
    <div className="flex flex-col items-center justify-center">
      ...
      >
        ...
        <div className="flex items-center justify-center space-x-2 sm:space-x-3 relative z-10">
          <motion.div
            animate={
              isGenerating ? { rotate: 360, scale: [1, 1.2, 1] } : { rotate: 0 }
            }
            transition={{
              duration: 1.5,
            ...
            className="bg-[#000000] p-0 rounded-full shadow-inner shadow-[#00FF00]/30 w-14 h-14 flex items-center justify-center overflow-hidden"
          >
            <img
              src={shuffleIcon}
              alt="Shuffle"
          ...
          <motion.span
            ...
            initial="idle"
            animate={
              isGenerating ? "generating" : isPressed ? "pressed" : "idle"
            }
